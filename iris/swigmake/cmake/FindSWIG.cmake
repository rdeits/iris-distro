...
#   SWIG_HAS_MATLAB_SUPPORT - whether this version of Swig can generate Matlab bindings
#
#
#
...
if(SWIG_EXECUTABLE)
  ...
  execute_process(COMMAND ${SWIG_EXECUTABLE} -E -matlab dummy.i
                  ...
                  OUTPUT_QUIET
                  ERROR_QUIET)
  if (swig_matlab_return_code EQUAL 0)
    message("Checking if Swig has Matlab support... yes")
    set(SWIG_HAS_MATLAB_SUPPORT TRUE)
  else()
    message("Checking if Swig has Matlab support... no")
    set(SWIG_HAS_MATLAB_SUPPORT FALSE)
  endif()
